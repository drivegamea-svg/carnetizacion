...
class UpdateProfesionTecnicaRequest extends FormRequest
{
    ...
    {
        $profesionTecnicaId = $this->route('profesionTecnica')->id;
        ...
        return [
            'nombre' => [
                ...
                Rule::unique('profesiones_tecnicas')->whereNull('deleted_at')->ignore($profesionTecnicaId)
            ],
