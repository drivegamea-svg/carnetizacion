...
@section('title', 'Profesiones Técnicas')
...
@section('content')
    <div id="content" class="app-content">
        <ol class="breadcrumb float-xl-end">
            ...
            <li class="breadcrumb-item active">Profesiones Técnicas</li>
        </ol>

        <h1 class="page-header">Profesiones Técnicas <small>Gestiona las profesiones técnicas del sistema</small></h1>
        ...
        <div class="alert alert-info alert-dismissible fade show mb-4">
            <div class="d-flex align-items-center">
                ...
                <div class="flex-fill">
                    <h5 class="alert-heading mb-1">¡Bienvenido a la gestión de profesiones técnicas!</h5>
                    <p class="mb-0">Aquí puedes administrar todas las profesiones técnicas disponibles para asignar a los afiliados.</p>
                </div>
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <i class="fa fa-tools me-2"></i>Listado de Profesiones Técnicas
                </h4>
                <div class="panel-heading-btn">
                    ...
                    @can('crear profesiones tecnicas')
                        <a href="{{ route('profesiones-tecnicas.create') }}" class="btn btn-primary btn-sm ms-2">
                            <i class="fa fa-plus me-1"></i> Nueva Profesión
                        </a>
                    @endcan
                </div>
            </div>
            ...
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped align-middle" id="profesiones-tecnicas-table"
                        width="100%">
                        <thead>
                            <tr>
                ...
                <div id="loading-state" class="text-center py-4">
                    ...
                    <p class="text-muted mt-2">Cargando profesiones técnicas...</p>
                </div>
            </div>
...
@push('scripts')
    ...
    <script>
        ...
        function confirmarEliminacion(id, nombre) {
            Swal.fire({
                title: '¿Eliminar Profesión Técnica?',
                html: `
                    <div class="text-center">
                        <div class="mb-3">
                            <i class="fa fa-exclamation-triangle fa-3x text-warning"></i>
                        </div>
                        <h5 class="text-danger mb-3">¿Estás seguro de eliminar esta profesión técnica?</h5>
                        <div class="alert alert-warning">
                            <strong><i class="fa fa-tools me-2"></i>${nombre}</strong>
                        </div>
                        <p class="text-muted">
        ...
        $(document).ready(function() {
            ...
            const table = $('#profesiones-tecnicas-table').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                ...
                ajax: '{{ route('profesiones-tecnicas.index') }}',
                initComplete: function() {
                    // Ocultar loading state
                    $('#loading-state').hide();
                    $('#profesiones-tecnicas-table').show();
                },
                columns: [{
                        data: 'id',
                            ...
                            return `
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <i class="fa fa-tools text-primary me-3 fs-5"></i>
                                    </div>
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            const canEdit =
                                {{ auth()->user()->can('editar profesiones tecnicas') ? 'true' : 'false' }};
                            const canDelete =
                                {{ auth()->user()->can('eliminar profesiones tecnicas') ? 'true' : 'false' }};

                            let buttons = '';

                            if (canEdit) {
                                buttons += `
                                    <a href="/profesiones-tecnicas/${data}/edit" 
                            ...
                            return `
                                ...
                                <form id="delete-form-${data}" 
                                      action="/profesiones-tecnicas/${data}" 
                ...
                drawCallback: function() {
                    ...
                    $('#info-registros').html(`
                            Mostrando <strong>${info.recordsDisplay}</strong> profesiones técnicas
                        `);
            ...
            $('#profesiones-tecnicas-table').on('mouseenter', 'tbody tr', function() {
