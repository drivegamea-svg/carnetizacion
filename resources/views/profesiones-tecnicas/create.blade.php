...
@section('title', 'Crear Profesión Técnica')
...
@section('content')
    <div id="content" class="app-content">
        ...
        <h1 class="page-header">Crear Profesión Técnica <small>Registrar nueva profesión técnica en el sistema</small></h1>
            ...
            <div class="col-xl-8">
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <form action="{{ route('profesiones-tecnicas.store') }}" method="POST" id="form-profesion-tecnica">
                            @csrf
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control text-uppercase @error('nombre') is-invalid @enderror" 
                                                   ...
                                                   placeholder="EJ: TÉCNICO EN INFORMÁTICA, TÉCNICO EN ELECTRICIDAD..." required
                                        ...
                                        <div class="form-text text-muted">
                                            <small>Ingrese un nombre único para la profesión técnica</small>
                                        </div>
                                    </div>
                                </div>
