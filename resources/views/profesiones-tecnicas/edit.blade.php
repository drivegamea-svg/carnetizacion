...
@section('title', 'Editar Profesión Técnica')
...
@section('content')
    <div id="content" class="app-content">
        <ol class="breadcrumb float-xl-end">
            ...
            <li class="breadcrumb-item"><a href="{{ route('profesiones-tecnicas.index') }}">Profesiones Técnicas</a></li>
            <li class="breadcrumb-item active">Editar Profesión</li>
        </ol>

        <h1 class="page-header">Editar Profesión Técnica <small>Modificar información de la profesión técnica</small></h1>
        ...
        <div class="row">
            ...
            <div class="col-xl-8">
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <form action="{{ route('profesiones-tecnicas.update', $profesionTecnica->id) }}" method="POST" id="form-profesion-tecnica">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        <label for="nombre" class="form-label">
                                            ...
                                            Nombre de la Profesión <span class="text-danger">*</span>
                                        </label>
                                        <div class="input-group">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   id="nombre" 
                                                   name="nombre" 
                                                   value="{{ old('nombre', $profesionTecnica->nombre) }}" 
                                                   placeholder="EJ: TÉCNICO EN INFORMÁTICA, TÉCNICO EN ELECTRICIDAD..." 
                                                   required
                                                   data-parsley-required-message="El nombre de la profesión técnica es obligatorio"
                                        ...
                                        <div class="form-text text-muted">
                                            <small>Modifique el nombre de la profesión técnica</small>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                                      ...
                                                      name="descripcion" 
                                                      rows="4" 
                                                      placeholder="Descripción opcional de la profesión técnica..."
                                                      data-parsley-maxlength="500"
                                                      data-parsley-maxlength-message="La descripción no puede exceder 500 caracteres">{{ old('descripcion', $profesionTecnica->descripcion) }}</textarea>
                                        </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <a href="{{ route('profesiones-tecnicas.index') }}" class="btn btn-default">
            ...
            <div class="col-xl-4">
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <i class="fa fa-info-circle me-2"></i>Información de la Profesión
                        </h4>
                        <div class="panel-heading-btn">
                    ...
                    <div class="panel-body">
                        <div class="mb-3">
                            ...
                            <span class="badge bg-primary">{{ $profesionTecnica->id }}</span>
                        </div>
                        <div class="mb-3">
                            <strong><i class="fa fa-calendar-plus me-2 text-success"></i>Creado:</strong> 
                            <span class="text-muted">{{ $profesionTecnica->created_at->format('d/m/Y H:i') }}</span>
                        </div>
                        <div class="mb-3">
                            <strong><i class="fa fa-calendar-check me-2 text-warning"></i>Última actualización:</strong> 
                            <span class="text-muted">{{ $profesionTecnica->updated_at->format('d/m/Y H:i') }}</span>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <ul class="list-unstyled ps-3">
                                ...
                                <li><i class="fa fa-info-circle text-info me-2"></i>Ayuda a identificar la profesión</li>
                            </ul>
                        </div>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#form-profesion-tecnica').parsley({
            ...
            $('#form-profesion-tecnica').on('submit', function(e) {
            ...
            $('#btn-reset').on('click', function() {
                $('#form-profesion-tecnica').parsley().reset();
                $('.form-control').removeClass('is-valid is-invalid');
                $('.invalid-feedback').hide();
                $('.parsley-errors-list').empty();
                
                // Restaurar valores originales
                $('#nombre').val('{{ old('nombre', $profesionTecnica->nombre) }}'.toUpperCase());
                $('#descripcion').val('{{ old('descripcion', $profesionTecnica->descripcion) }}'.toUpperCase());
            });
            ...
            @if($errors->any())
                ...
                setTimeout(function() {
                    $('#form-profesion-tecnica').parsley().validate();
                }, 100);
            @endif
