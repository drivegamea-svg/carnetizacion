...
@section('content')
    <div id="content" class="app-content">
        ...
        <h1 class="page-header">Editar Especialidad <small>Modificar información de la especialidad</small></h1>
        ...
        <div class="row">
            ...
            <div class="col-xl-8">
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <form action="{{ route('especialidades.update', $especialidad->id) }}" method="POST" id="form-especialidad">
                            @csrf
                            @method('PUT')
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   placeholder="EJ: REDES Y CONECTIVIDAD, SOPORTE TÉCNICO..." 
                                                   required
                                                   data-parsley-required-message="El nombre de la especialidad es obligatorio"
                                        ...
                                        <div class="form-text text-muted">
                                            <small>Modifique el nombre de la especialidad</small>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                                      ...
                                                      data-parsley-maxlength-message="La descripción no puede exceder 500 caracteres">{{ old('descripcion', $especialidad->descripcion) }}</textarea>
                                        </div>
            ...
            <div class="col-xl-4">
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <i class="fa fa-info-circle me-2"></i>Información de la Especialidad
                        </h4>
                        <div class="panel-heading-btn">
                    ...
                    <div class="panel-body">
                        <div class="mb-3">
                            ...
                            <span class="badge bg-primary">{{ $especialidad->id }}</span>
                        </div>
                        <div class="mb-3">
                            <strong><i class="fa fa-calendar-plus me-2 text-success"></i>Creado:</strong> 
                            <span class="text-muted">{{ $especialidad->created_at->format('d/m/Y H:i') }}</span>
                        </div>
                        <div class="mb-3">
                            <strong><i class="fa fa-calendar-check me-2 text-warning"></i>Última actualización:</strong> 
                            <span class="text-muted">{{ $especialidad->updated_at->format('d/m/Y H:i') }}</span>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <ul class="list-unstyled ps-3">
                                ...
                                <li><i class="fa fa-info-circle text-info me-2"></i>Ayuda a identificar la especialidad</li>
                            </ul>
                        </div>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#form-especialidad').on('submit', function(e) {
            ...
            $('#btn-reset').on('click', function() {
                $('#form-especialidad').parsley().reset();
                $('.form-control').removeClass('is-valid is-invalid');
                $('.invalid-feedback').hide();
                $('.parsley-errors-list').empty();
                
                // Restaurar valores originales
                $('#nombre').val('{{ old('nombre', $especialidad->nombre) }}'.toUpperCase());
                $('#descripcion').val('{{ old('descripcion', $especialidad->descripcion) }}'.toUpperCase());
            });
            ...
            @if($errors->any())
                ...
                setTimeout(function() {
                    $('#form-especialidad').parsley().validate();
                }, 100);
            @endif
