...
@section('content')
    <div id="content" class="app-content">
        ...
        <h1 class="page-header">Crear Especialidad <small>Registrar nueva especialidad en el sistema</small></h1>
            ...
            <div class="col-xl-8">
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <form action="{{ route('especialidades.store') }}" method="POST" id="form-especialidad">
                            @csrf
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control text-uppercase @error('nombre') is-invalid @enderror" 
                                                   ...
                                                   placeholder="EJ: REDES Y CONECTIVIDAD, SOPORTE TÉCNICO..." required
                                        ...
                                        <div class="form-text text-muted">
                                            <small>Ingrese un nombre único para la especialidad</small>
                                        </div>
                                    </div>
                                </div>
