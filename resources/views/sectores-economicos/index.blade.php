...
@section('content')
    <div id="content" class="app-content">
        ...
        <h1 class="page-header">Sectores Económicos <small>Gestiona los sectores económicos del sistema</small></h1>

        <!-- Alertas de información -->
        <div class="alert alert-info alert-dismissible fade show mb-4">
            <div class="d-flex align-items-center">
                <i class="fa fa-chart-pie fa-2x me-3"></i>
                <div class="flex-fill">
                    <h5 class="alert-heading mb-1">¡Bienvenido a la gestión de sectores económicos!</h5>
                    <p class="mb-0">Aquí puedes administrar todos los sectores económicos disponibles para asignar a los afiliados.</p>
                </div>
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <i class="fa fa-chart-pie me-2"></i>Listado de Sectores Económicos
                </h4>
                <div class="panel-heading-btn">
                    ...
                    @can('crear sectores economicos')
                        <a href="{{ route('sectores-economicos.create') }}" class="btn btn-primary btn-sm ms-2">
                            <i class="fa fa-plus me-1"></i> Nuevo Sector
                        </a>
                    @endcan
                </div>
            </div>
            ...
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped align-middle" id="sectores-economicos-table"
                        width="100%">
                        <thead>
                            <tr>
                ...
                <div id="loading-state" class="text-center py-4">
                    ...
                    <p class="text-muted mt-2">Cargando sectores económicos...</p>
                </div>
            </div>
...
@push('scripts')
    ...
    <script>
            ...
            Swal.fire({
                ...
                html: `
                    <div class="text-center">
                        ...
                        <h5 class="text-danger mb-3">¿Estás seguro de eliminar este sector económico?</h5>
                        <div class="alert alert-warning">
                            <strong><i class="fa fa-chart-pie me-2"></i>${nombre}</strong>
                        </div>
                        <p class="text-muted">
        ...
        $(document).ready(function() {
            ...
            const table = $('#sectores-economicos-table').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                ...
                ajax: '{{ route('sectores-economicos.index') }}',
                initComplete: function() {
                    // Ocultar loading state
                    $('#loading-state').hide();
                    $('#sectores-economicos-table').show();
                },
                columns: [{
                        data: 'id',
                            ...
                            return `
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <i class="fa fa-chart-pie text-primary me-3 fs-5"></i>
                                    </div>
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            const canEdit =
                                {{ auth()->user()->can('editar sectores economicos') ? 'true' : 'false' }};
                            const canDelete =
                                {{ auth()->user()->can('eliminar sectores economicos') ? 'true' : 'false' }};

                            let buttons = '';

                            if (canEdit) {
                                buttons += `
                                    <a href="/sectores-economicos/${data}/edit" 
                            ...
                            return `
                                ...
                                <form id="delete-form-${data}" 
                                      action="/sectores-economicos/${data}" 
                ...
                drawCallback: function() {
                    ...
                    $('#info-registros').html(`
                            Mostrando <strong>${info.recordsDisplay}</strong> sectores económicos
                        `);
            ...
            $('#sectores-economicos-table').on('mouseenter', 'tbody tr', function() {
