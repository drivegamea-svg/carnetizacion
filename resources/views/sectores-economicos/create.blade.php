...
@section('title', 'Crear Sector Económico')
...
@section('content')
    <div id="content" class="app-content">
        ...
        <h1 class="page-header">Crear Sector Económico <small>Registrar nuevo sector económico en el sistema</small></h1>
            ...
            <div class="col-xl-8">
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <form action="{{ route('sectores-economicos.store') }}" method="POST" id="form-sector-economico">
                            @csrf
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control text-uppercase @error('nombre') is-invalid @enderror" 
                                                   ...
                                                   placeholder="EJ: INDUSTRIA, COMERCIO, SERVICIOS..." required
                                        ...
                                        <div class="form-text text-muted">
                                            <small>Ingrese un nombre único para el sector económico</small>
                                        </div>
                                    </div>
                                </div>
