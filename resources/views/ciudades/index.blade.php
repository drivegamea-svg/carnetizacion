...
@section('content')
    <div id="content" class="app-content">
        ...
        <h1 class="page-header">Ciudades <small>Gestiona las ciudades del sistema</small></h1>

        <!-- Alertas de información -->
        <div class="alert alert-info alert-dismissible fade show mb-4">
            <div class="d-flex align-items-center">
                <i class="fa fa-city fa-2x me-3"></i>
                <div class="flex-fill">
                    <h5 class="alert-heading mb-1">¡Bienvenido a la gestión de ciudades!</h5>
                    <p class="mb-0">Aquí puedes administrar todas las ciudades disponibles para asignar a los afiliados.</p>
                </div>
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <i class="fa fa-city me-2"></i>Listado de Ciudades
                </h4>
                <div class="panel-heading-btn">
                    ...
                    @can('crear ciudades')
                        <a href="{{ route('ciudades.create') }}" class="btn btn-primary btn-sm ms-2">
                            <i class="fa fa-plus me-1"></i> Nueva Ciudad
                        </a>
                    @endcan
                </div>
            </div>
            ...
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped align-middle" id="ciudades-table"
                        width="100%">
                        <thead>
                            <tr>
                                ...
                                <th width="18%" class="text-center">Creado</th>
...
@push('scripts')
    ...
    <script>
            ...
            Swal.fire({
                ...
                html: `
                    <div class="text-center">
                        ...
                        <h5 class="text-danger mb-3">¿Estás seguro de eliminar esta ciudad?</h5>
                        <div class="alert alert-warning">
                            <strong><i class="fa fa-city me-2"></i>${nombre}</strong>
                        </div>
                        <p class="text-muted">
        ...
        $(document).ready(function() {
            ...
            const table = $('#ciudades-table').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                ...
                columns: [{
                            ...
                            return `
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <i class="fa fa-city text-primary me-3 fs-5"></i>
                                    </div>
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            return `
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <i class="fa fa-map-marker-alt text-success me-3 fs-5"></i>
                                    </div>
                                    <div class="flex-grow-1">
                                        <div class="fw-semibold text-success">${data}</div>
                                    </div>
                                </div>
                            `;
                        }
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            const canEdit =
                                {{ auth()->user()->can('editar ciudades') ? 'true' : 'false' }};
                            const canDelete =
                                {{ auth()->user()->can('eliminar ciudades') ? 'true' : 'false' }};

                            let buttons = '';

                            if (canEdit) {
                                buttons += `
                                    <a href="/ciudades/${data}/edit" 
                ...
                drawCallback: function() {
                    ...
                    $('#info-registros').html(`
                            Mostrando <strong>${info.recordsDisplay}</strong> ciudades
                        `);
            ...
            $('#ciudades-table').on('mouseenter', 'tbody tr', function() {
