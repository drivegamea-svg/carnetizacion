...
@section('title', 'Editar Organización Social')
...
@section('content')
    <div id="content" class="app-content">
        ...
        <h1 class="page-header">Editar Organización Social <small>Modificar información de la organización social</small></h1>
        ...
        <div class="row">
            ...
            <div class="col-xl-8">
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <form action="{{ route('organizaciones-sociales.update', $organizacionSocial->id) }}" method="POST" id="form-organizacion-social">
                            @csrf
                            @method('PUT')
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   id="nombre" 
                                                   name="nombre" 
                                                   value="{{ old('nombre', $organizacionSocial->nombre) }}" 
                                                   placeholder="EJ: ASOCIACIÓN DE VECINOS, FUNDACIÓN SOLIDARIA..." 
                                                   required
                                        ...
                                        <div class="form-text text-muted">
                                            <small>Modifique el nombre de la organización social</small>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                                      ...
                                                      data-parsley-maxlength-message="La descripción no puede exceder 500 caracteres">{{ old('descripcion', $organizacionSocial->descripcion) }}</textarea>
                                        </div>
            ...
            <div class="col-xl-4">
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <i class="fa fa-info-circle me-2"></i>Información de la Organización
                        </h4>
                        <div class="panel-heading-btn">
                    ...
                    <div class="panel-body">
                        <div class="mb-3">
                            ...
                            <span class="badge bg-primary">{{ $organizacionSocial->id }}</span>
                        </div>
                        <div class="mb-3">
                            <strong><i class="fa fa-calendar-plus me-2 text-success"></i>Creado:</strong> 
                            <span class="text-muted">{{ $organizacionSocial->created_at->format('d/m/Y H:i') }}</span>
                        </div>
                        <div class="mb-3">
                            <strong><i class="fa fa-calendar-check me-2 text-warning"></i>Última actualización:</strong> 
                            <span class="text-muted">{{ $organizacionSocial->updated_at->format('d/m/Y H:i') }}</span>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btn-reset').on('click', function() {
                ...
                $('#nombre').val('{{ old('nombre', $organizacionSocial->nombre) }}'.toUpperCase());
                $('#descripcion').val('{{ old('descripcion', $organizacionSocial->descripcion) }}'.toUpperCase());
            });
