...
@section('title', 'Organizaciones Sociales')
...
@section('content')
    <div id="content" class="app-content">
        <ol class="breadcrumb float-xl-end">
            ...
            <li class="breadcrumb-item active">Organizaciones Sociales</li>
        </ol>

        <h1 class="page-header">Organizaciones Sociales <small>Gestiona las organizaciones sociales del sistema</small></h1>

        <!-- Alertas de información -->
        <div class="alert alert-info alert-dismissible fade show mb-4">
            <div class="d-flex align-items-center">
                <i class="fa fa-hands-helping fa-2x me-3"></i>
                <div class="flex-fill">
                    <h5 class="alert-heading mb-1">¡Bienvenido a la gestión de organizaciones sociales!</h5>
                    <p class="mb-0">Aquí puedes administrar todas las organizaciones sociales disponibles para asignar a los afiliados.</p>
                </div>
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <i class="fa fa-hands-helping me-2"></i>Listado de Organizaciones Sociales
                </h4>
                <div class="panel-heading-btn">
                    ...
                    @can('crear organizaciones sociales')
                        <a href="{{ route('organizaciones-sociales.create') }}" class="btn btn-primary btn-sm ms-2">
                            <i class="fa fa-plus me-1"></i> Nueva Organización
                        </a>
                    @endcan
                </div>
            </div>
            ...
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped align-middle" id="organizaciones-sociales-table"
                        width="100%">
                        <thead>
                            <tr>
                ...
                <div id="loading-state" class="text-center py-4">
                    ...
                    <p class="text-muted mt-2">Cargando organizaciones sociales...</p>
                </div>
            </div>
...
@push('scripts')
    ...
    <script>
        ...
        function confirmarEliminacion(id, nombre) {
            Swal.fire({
                title: '¿Eliminar Organización Social?',
                html: `
                    <div class="text-center">
                        <div class="mb-3">
                            <i class="fa fa-exclamation-triangle fa-3x text-warning"></i>
                        </div>
                        <h5 class="text-danger mb-3">¿Estás seguro de eliminar esta organización social?</h5>
                        <div class="alert alert-warning">
                            <strong><i class="fa fa-hands-helping me-2"></i>${nombre}</strong>
                        </div>
                        <p class="text-muted">
        ...
        $(document).ready(function() {
            ...
            const table = $('#organizaciones-sociales-table').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                ...
                ajax: '{{ route('organizaciones-sociales.index') }}',
                initComplete: function() {
                    // Ocultar loading state
                    $('#loading-state').hide();
                    $('#organizaciones-sociales-table').show();
                },
                columns: [{
                        data: 'id',
                            ...
                            return `
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <i class="fa fa-hands-helping text-primary me-3 fs-5"></i>
                                    </div>
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            const canEdit =
                                {{ auth()->user()->can('editar organizaciones sociales') ? 'true' : 'false' }};
                            const canDelete =
                                {{ auth()->user()->can('eliminar organizaciones sociales') ? 'true' : 'false' }};

                            let buttons = '';

                            if (canEdit) {
                                buttons += `
                                    <a href="/organizaciones-sociales/${data}/edit" 
                            ...
                            return `
                                ...
                                <form id="delete-form-${data}" 
                                      action="/organizaciones-sociales/${data}" 
                ...
                drawCallback: function() {
                    ...
                    $('#info-registros').html(`
                            Mostrando <strong>${info.recordsDisplay}</strong> organizaciones sociales
                        `);
            ...
            $('#organizaciones-sociales-table').on('mouseenter', 'tbody tr', function() {
